...
import com.eugene.loading.callback.SuccessCallback;
...
public class LoadService<T> {
    ...
    LoadService(Converter<T> converter, TargetContext targetContext, Callback.OnReloadListener onReloadListener,
